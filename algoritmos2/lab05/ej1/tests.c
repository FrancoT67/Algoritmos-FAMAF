...
void test_head()
{
    ...
    struct head_testcase tests[N_TESTCASES_HEAD] = {
        ...
        {{5, 1, -2, 6, 4}, 5, 5},         // testea: head([5, 1, -2, 6, 4]) == 5
        {{-4, 1, -2, 3, 1, 4, 5}, 6, -4}, // testea: head([-4, 1, -2,3,1,4,5]) == -4
    };
...
void test_index()
{
    ...
    struct index_testcase tests[N_TESTCASES_INDEX] = {
        ...
        {{8, 1, -2, 4, 46, 8, 5, 4}, 8, 3, 4}, // testea: index([8,1,-2,4,46,8,5,4], 3) == 4
        {{8, 1, -2, 4, 46, 8, 5, 4}, 8, 6, 5}, // testea: index([8,1,-2,4,46,8,5,4], 6) == 5
    };
...
void test_length()
{
    ...
    struct length_testcase tests[N_TESTCASES_LENGTH] = {
        ...
        {{8, 1, -2, 3}, 4},    // testea: length([8, 1, -2,3]) == 4
        {{8, 1, -2, 3, 7}, 5}, // testea: length([8, 1, -2,3,7]) == 5
    };
